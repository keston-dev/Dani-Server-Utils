...
export default class MiscUtilities {
   ...
   * @returns string
   */
  public unicodeToAscii(name: string): string {
   ...
   * @returns string
   */
  public eliminateUnicode(name: string): string {
    let finalName = "";
  ...
  public isColor(value: any): value is ColorResolvable {
   ...
   */
  public fuzzyMatch(message: string, phrase: string): number {
