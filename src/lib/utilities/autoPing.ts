...
import { AutoPingModel } from "models/AutoPing.ts";
import { DsuClient } from "../core/DsuClient.ts";
import { IAutoPing } from "types/mongodb.ts";
...
export class AutoPingUtility {
  ...
  async onThreadCreated(thread: AnyThreadChannel) {
